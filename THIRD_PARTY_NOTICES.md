...
zlib 1.3.1 (Zlib), both linked into the drivers, and Expat 2.5.0 (MIT), which is not. The
notices for everything compiled into the drivers are in `android/NOTICE.txt`, which every
package includes.
