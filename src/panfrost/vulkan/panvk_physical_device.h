...
/* ARM kbase node. Used when the system exposes no DRM render node at all, which is the
 * normal case on a stock Arm Android device. */
#define PANVK_KBASE_PATH "/dev/mali0"
