...
struct panfrost_screen {
   ...
   /* The compiler's options for application shaders, with doubles done in
    * software (Mali has no fp64). */
   nir_shader_compiler_options nir_options[MESA_SHADER_STAGES];
   struct {
